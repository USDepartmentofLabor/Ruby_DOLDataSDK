...
=======
    API_URL = 'V1'
>>>>>>> ca295954950ee4231a318c799b82c4b3d17f7de6:GOVDataSDK.rb
...
=======
        attr_accessor :host, :key, :secret, :login, :data, :url
          
        def initialize host, key, secret, login, data
           @host, @key, @secret, @login, @data = host, key, secret, login, data
            @url = API_URL
>>>>>>> ca295954950ee4231a318c799b82c4b3d17f7de6:GOVDataSDK.rb
